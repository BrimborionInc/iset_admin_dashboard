...
const checks = [
  ...
  },
  {
    ...
    patterns: [
      'validateDocumentAccess(req, doc)',
      'validateDocumentDeleteIntegrity(doc)',
  ...
  },
  {
    ...
    patterns: [
      ...
      'attachment_application_scope_mismatch',
      ...
      'document adoption skipped for message',
      'presignGet',
    ],
    after: 12000,
  },
  {
    name: 'admin attachment adoption preserves existing document ownership and soft lineage',
    source: 'admin',
    anchor: 'function assertMessageAttachmentDocumentScope',
    patterns: [
      "'case_id'",
      "'client_id'",
      "'applicant_user_id'",
      'isKnownLegacyMessageAttachmentApplicantRelinkCollision',
      'messageAttachmentDocumentHasNonOwnershipScopeDifference',
  ...
  {
    name: 'admin signing replies revalidate the current participant under lock',
    source: 'admin',
    anchor: 'const handlePostCaseSecureMessage = async (req, res) =>',
    patterns: [
  ...
  },
  {
    ...
    patterns: [
      ...
      'prepareApplicantMessageAttachments',
      'writeApplicantSecureMessage',
    ],
    extraction: 'express-route',
  },
  {
    name: 'public message writes bind scope and staged uploads transactionally',
    source: 'portal',
    anchor: 'async function writeApplicantSecureMessage',
    patterns: [
      'lockAndValidateApplicantMutableMessageTarget',
      'lockPreparedApplicantMessageUploads',
