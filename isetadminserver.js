...
const DUMMY_APPLICATION_PROFILES = [
  {
    ...
    conflict: { value: 'no_conflict', follow: '' },
    payload: {
      'consent': { name: 'Anne Applicant', signed: true },
      'indigenous-affiliation-declaration': 'Mohawk of Kahnawà:ke',
      ...
      'telephone-day': '(151) 497 5169',
      'contact-email-address': 'bill@sillery.co.uk',
      'telephone-alt': '(613) 111 4444',
      'address-mailing-address': '123 Frobisher Street\nOxford\nKentucky',
  ...
  },
  {
    ...
    payload: {
      ...
      'address-street-address': '96 Clearwater Road',
      'address-city': 'The Pas',
      'address-province': 'mb',
      'address-postcode': 'R9A 2J7',
      'telephone-day': '(204) 555-7742',
      'contact-email-address': 'noah.whitecloud@example.com',
      'telephone-alt': '(204) 555-7746',
      'address-mailing-address': 'PO Box 210\nThe Pas\nMB',
      'emergency-contact-name': 'Jordan Whitecloud',
      'emergency-contact-telephone': '(204) 555-7740',
      'emergency-contact-relationship': 'Spouse',
      'legal-indigenous-identity': 'first_nations_non_status',
      'registration-number': 'OCN-458321',
      ...
      'example-radio-2': 'high_school',
      'education-year': '2005',
      'education-location': 'mb',
      'long-term-goal': 'Open a community-owned repair co-operative.',
      'barriers': ['lack-of-job-opportunities', 'other'],
      'target-program': 'skills_development',
      'requested-supports': ['tools', 'tuition'],
      'disability-support': 'no',
      'income-employment': '850',
      'income-spousal': '600',
      'income-social-assist': '0',
      'income-child-support': '0',
      ...
      'income-band-funding': '0',
      'income-alimony': '0',
      'income-other': 'Traditional crafts',
      'income-other-description': 'winter market sales',
      'expenses-rent': '920',
      'expenses-groceries': '520',
      'expenses-utilities': '210',
      'expenses_transport': ['buss_pass', 'mileage'],
      'expenses-other-list': 'Fuel for trapping line',
      'example-input-5': '75',
      'status-card': [],
      'govt-id': [],
      'acceptance-letter': [],
