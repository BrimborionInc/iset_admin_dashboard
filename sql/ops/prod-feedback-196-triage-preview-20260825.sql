-- Read-only PROD preview for feedback #196 triage metadata.
-- Live PROD identity and full DDL for all three feedback tables must be
-- captured in the current task before this file is executed.
