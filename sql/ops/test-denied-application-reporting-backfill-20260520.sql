-- TEST rehearsal: backfill denied-application reporting artifacts.
-- Scope: TEST only. Do not run against PROD without reviewing candidate output
-- and changing the run id / restore-point notes for the PROD operation.

SET @backfill_run_id = 'test-denied-application-reporting-backfill-20260520';
