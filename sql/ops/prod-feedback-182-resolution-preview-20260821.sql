-- Read-only current-state preview for canonical feedback 182 resolution.

SELECT DISTINCT admin_feedback_report.status
  FROM admin_feedback_report
 ORDER BY admin_feedback_report.status;
