...
const widgetRegistry = {
  requests: {
    ...
    description: "Submitted payment packets awaiting review or confirmation.",
  ...
  detail: {
    ...
    description: "Documents, notes, and actions for the selected packet.",
  ...
  comms: {
    ...
    description: "Email log for requests and confirmations.",
  ...
  sla: {
    ...
    title: "SLA snapshot",
    description: "Status distribution and turnaround metrics.",
