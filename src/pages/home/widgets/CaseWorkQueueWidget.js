...
const CaseWorkQueueWidget = ({ role, refreshKey = 0, actions }) => {
  ...
  return (
    <BoardItem
      header={<Header variant="h2" description="Cases currently in your remit by status. PATH now creates or matches a client case file as soon as a submitted application is received.">Case Work Queue</Header>}
