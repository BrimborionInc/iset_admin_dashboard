...
const boardI18nStrings = {
  empty: 'No widgets on the Documentation dashboard. Use Add widget to add the library or reader.',
  ...
  navigationAriaLabel: 'Documentation dashboard navigation',
...
const DocumentationLibrary = ({
  ...
  useEffect(() => {
    if (typeof updateBreadcrumbs === 'function') {
      updateBreadcrumbs([{ text: 'Home', href: '/' }, { text: 'Documentation', href: '/documentation' }]);
    }
  }, [updateBreadcrumbs]);
    ...
    <Board
      ...
      empty={
        <Container header={<Header variant="h2">No widgets</Header>}>
          <Box variant="p" color="text-body-secondary">
            Add the library and reader widgets to start browsing documentation.
          </Box>
        </Container>
      }
    />
