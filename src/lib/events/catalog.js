...
const EVENT_CATEGORIES = [
  ...
  },
  {
    ...
    types: [
      ...
      { id: 'case_unassigned', label: 'Case unassigned', severity: 'warning', source: 'admin' },
      { id: 'case_reassigned', label: 'Case reassigned', severity: 'info', source: 'admin', draft: true },
      { id: 'case_approved', label: 'Case approved', severity: 'success', source: 'admin' },
      { id: 'case_rejected', label: 'Case rejected', severity: 'error', source: 'admin' }
    ]
  },
  {
    id: 'assessment',
  ...
  },
  {
    ...
    severity: 'warning',
    types: [
      { id: 'system_error', label: 'System error', severity: 'error', source: 'system', locked: true }
    ]
  }
];
