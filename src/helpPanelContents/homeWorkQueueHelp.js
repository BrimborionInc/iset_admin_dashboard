...
const HomeWorkQueueHelp = () => (
  <SpaceBetween size="s">
    ...
    <Box>
      ...
      client-case queue is case-based rather than deduped by person and still includes files with no active plan. <strong>Pending Decision</strong>
