...
const CaseWorkspaceProposedInterventionsHelp = () => (
  <div>
    ...
    <ul>
      ...
      <li>Use the Other funding step to mark whether outside funding exists, record each funder as confirmed, pending, denied, or unknown, and state what NWAC will cover.</li>
