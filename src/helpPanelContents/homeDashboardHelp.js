...
const HomeDashboardHelp = () => (
  <div>
    ...
    <p>
      ...
      a quick metrics snapshot, recent activity, and your watchlist so you can jump into priority files quickly.
    </p>
    ...
    <ul>
      ...
      <li>Keep a personal watchlist of files that need follow-up.</li>
    ...
    <ul>
      ...
      <li><strong>My Watchlist</strong> - cases you have flagged for follow-up; clear flags once resolved.</li>
    ...
    <ul>
      ...
      <li>Use the flag icon in Work Queue Items to add or remove cases from your watchlist.</li>
    </ul>
  </div>
);

HomeDashboardHelp.aiContext = `You are assisting a user on the NWAC ISET homepage (route /). This dashboard is a role-based landing board that shows work queues, queue items, metrics, recent activity, and watchlists. Program Administrators and Regional Managers see the consolidated Work Queue and Work Queue Items widgets plus Metrics. ISET Coordinators see the ISET-specific queue, Work Queue Items, and Metrics. System Administrators see the development tracker widget instead of Metrics.
