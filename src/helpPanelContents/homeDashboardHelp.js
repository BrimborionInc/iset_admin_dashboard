  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Manage conflicts of interest, approvals, and escalations through the queue selections.</li>
      </ul>

      <h3>Key widgets</h3>
      <ul>
        <li><strong>Work Queue</strong> - queue counts that reflect your role. Select a queue to drive the queue table.</li>
...
Guide users to select a work queue to populate the Work Queue Items table, use filters to find a record, and open the linked workspace. Mention Add widget and Reset layout actions, and remind them that layouts are stored per browser.
`;
