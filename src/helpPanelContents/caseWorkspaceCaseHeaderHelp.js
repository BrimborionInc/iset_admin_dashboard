...
const CaseWorkspaceCaseHeaderHelp = () => (
  <div>
    ...
    <ul>
      ...
      <li><strong>Quick actions:</strong> actions such as reassignment, PATH account activation, or <strong>View audit trail</strong>, depending on the file and your role.</li>
    </ul>
