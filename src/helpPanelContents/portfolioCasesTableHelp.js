...
const PortfolioCasesTableHelp = () => (
  <div>
    ...
    <ul>
      ...
      <li><strong>Show No Active Plan Clients</strong>: client files in case lifecycle <strong>No Active Plan</strong>, <strong>Closed</strong>, or <strong>Archived</strong>. Reporting-only denied or ineligible files are excluded.</li>
      <li><strong>Show Denied / Ineligible Clients</strong>: files flagged as denied or ineligible for reporting-only tracking.</li>
      <li><strong>Show All Clients</strong>: all accessible case-management client files across Initiated, Active, No Active Plan, Ready to close, Closed, and Archived, including reporting-only denied or ineligible files.</li>
    </ul>
