...
const PortfolioCasesTableHelp = () => (
  <div>
    ...
    <ul>
      ...
      <li><strong>Show Ineligible Clients</strong>: files flagged as denied or ineligible for reporting-only tracking.</li>
