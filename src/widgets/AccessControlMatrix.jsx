...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/configuration/applicant-watchlist', label: 'Applicant Watchlist' },
      { href: '/configuration-settings', label: 'Configuration Settings' },
      { href: '/iset/imports/client-files', label: 'Client Batch Import' },
...
const ROUTE_LABELS = {
  ...
  '/configuration/applicant-watchlist': 'Applicant Watchlist',
  ...
  '/iset/imports/client-files': 'Client Batch Import',
