...
## Repos in scope
- Admin dashboard: `X:\ISET\admin-dashboard`
- Mock service: `X:\ISET\intacct-mock-service`
...
- Vendors are seeded in memory, with optional MySQL persistence for vendor records only.
- No downstream bill lifecycle exists yet beyond initial create/get.
...
- Then inspect:
  - `X:\ISET\intacct-mock-service\src\server.js`
  - `X:\ISET\admin-dashboard\isetadminserver.js`
  - `X:\ISET\admin-dashboard\src\pages\finance\widgets\FinanceIntacctIntegrationWidget.jsx`
  - `X:\ISET\admin-dashboard\src\pages\finance\widgets\PaymentDetailWidget.jsx`
  - `X:\ISET\admin-dashboard\src\pages\finance\widgets\ReconciliationDataContext.jsx`
