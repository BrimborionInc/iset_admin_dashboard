...
- PROD repair follow-up (2026-07-27): the July 22 EI prefill was only a narrow pending-revision repair, not a complete correction of Solana's fiscal-year-spanning historical agreement. After the Decision Maker returned that revision and Amanda deleted it, the complete guarded repair `sql/ops/prod-solana-case41-fiscal-split-apply-20260727.sql` closed January-March plan `23` with result `Returned to school`, activated April renewal plan `143` as EI Reach Back, moved/completed historical intervention `311` under plan `143` with actual `$3,077.21`, created its posted historical finance and independent ILMP rows, removed April-June contamination from intervention `32`, and archived the orphaned revision workflow/PDF. Treat case event `266` and the July 27 repair as the current state; event `247` remains immutable history of the superseded attempt.
