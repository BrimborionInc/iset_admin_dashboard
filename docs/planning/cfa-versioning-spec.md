...
- PROD feedback `#166` is the tracked live item. Document `5539` was restored on 2026-07-27; the report remains `in_progress` pending deployed prevention and targeted live UI confirmation.
