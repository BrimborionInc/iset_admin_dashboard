...
- Keep external-AI checks strict: admin/public OpenRouter calls must not receive raw applicant/client identifiers or live case context. Denial-letter drafts stay local-template only, and AI dummy-data routes stay behind the unsafe debug gate.
