...
| `/finance/reports` | Finance Reports | Finance / reporting | P1 | `financeReportsHelp.js`; financial reports docs | inventory-only | Cover report lifecycle, validation, certification, export history, and workbook semantics. |
