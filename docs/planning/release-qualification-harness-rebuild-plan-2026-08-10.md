...
- Current authorized phase/sprint: none; Sprints `0A` through `3F`, repository-hygiene Sprint `3G-H1`, diagnostic Sprint `3G-D1`, the bounded Sprint `3G` design/corrective work, and scope reconciliation `3G-SR1` are closed. SR1 retained the complete partial-3G qualification state under content address `816dd809d88844a2645cd9d5eafc2d603df17cf027ecf44b623e40482579c430`, restored the exact certified five-pack control plane from `176419dd3cf93d8c6398d49196301b5075d72a09`, removed the unadmitted portal pack/test/sentinels from active code, and proved exact adapter `2.0.0`, role `1.8.0`, registry and pack/input identities without native dispatch. `portal-aggregate` is deferred from the Phase 3 advisory cohort; the current authoritative gate remains unchanged and RN02/RN04 remain open no-loss obligations. Bill must review/accept `3G-SR1` and separately authorize Sprint `3H` exactly as recorded in the architecture; Phase 4 remains unauthorized.
