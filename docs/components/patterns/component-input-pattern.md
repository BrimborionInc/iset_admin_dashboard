...
- Input Mask: Optional formatting helper (Phone NA, SIN, **Status RN**, Bank Transit Number (5 digits), Bank Institution Number (3 digits), Postal/ZIP, Date YYYY-MM-DD, Time HH:MM, Currency). Status RN formats the 10-digit Secure Certificate of Indian Status registration number as `123 4567890` and restricts input to digits.
