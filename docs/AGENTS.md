...
- Case Header now exposes explicit backload quick actions on application-less cases: `Add existing action plan`, `Add existing intervention`, and `Upload existing documents`. Future product consideration: users may need historical plan/intervention backload on application-backed cases too; see `docs/planning/case-workspace-quick-actions.md` before changing the application-less quick-action gate.
