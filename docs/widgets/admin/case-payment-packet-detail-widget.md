# Case Payment Packet Detail widget
...
- src/pages/Caseworking/caseWorkspace/widgets/CasePaymentDetailWidget.jsx
...
Line-item/evidence detail for selected case packet.
