# ESDC Participant Workspace Validation Summary widget
...
- src/pages/esdc/widgets/EsdcValidationSummaryWidget.jsx
...
Blocking vs warning state for participant payload.
