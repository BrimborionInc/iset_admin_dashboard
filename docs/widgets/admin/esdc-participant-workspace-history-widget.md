# ESDC Participant Workspace Submission History widget
...
- src/pages/esdc/widgets/EsdcSubmissionHistoryWidget.jsx
...
Submission audit log for participant-level actions.
