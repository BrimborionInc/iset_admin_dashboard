...
- Staff compose displays the case-derived applicant recipient as read-only and requires the staff user to confirm the recipient/case before Send. The visible `To` label is not routing authority; backend routing remains case/applicant scoped.
