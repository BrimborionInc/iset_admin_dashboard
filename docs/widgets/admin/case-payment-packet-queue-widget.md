# Case Payment Packet Queue widget
...
- src/pages/Caseworking/caseWorkspace/widgets/CasePaymentRequestsWidget.jsx
...
Case-linked packet queue for draft/submitted payment packets.
