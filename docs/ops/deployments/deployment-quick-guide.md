...
- The `shared` tree is a local Git repo as of 2026-07-08, but may still lack a GitHub remote. Until a remote exists and is pushed, verify local status before deploy and remember that off-machine recovery still depends on the local WSL disk.
