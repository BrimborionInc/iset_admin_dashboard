...
## 2026-05-28
- UX/Finance Reports/DEV: Renamed the Financial Reports Intervention detail all-rows selector from `All approved interventions` to `All reportable interventions` and clarified the hint text to say it includes zero-dollar rows, including denied-application reporting records.
