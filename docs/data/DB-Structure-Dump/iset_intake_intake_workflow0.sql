...
--
-- Dumping data for table `intake_workflow`
--

LOCK TABLES `intake_workflow` WRITE;
/*!40000 ALTER TABLE `intake_workflow` DISABLE KEYS */;
/*!40000 ALTER TABLE `intake_workflow` ENABLE KEYS */;
UNLOCK TABLES;
