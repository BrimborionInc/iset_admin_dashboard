...
--
-- Dumping data for table `iset_document`
--

LOCK TABLES `iset_document` WRITE;
/*!40000 ALTER TABLE `iset_document` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_document` ENABLE KEYS */;
UNLOCK TABLES;
