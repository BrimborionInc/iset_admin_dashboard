...
--
-- Table structure for table `esdc_reporting_note`
--

DROP TABLE IF EXISTS `esdc_reporting_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `esdc_reporting_note` (
  ...
  KEY `fk_esdc_reporting_note_author` (`author_user_id`),
...
--
-- Dumping data for table `esdc_reporting_note`
--

LOCK TABLES `esdc_reporting_note` WRITE;
/*!40000 ALTER TABLE `esdc_reporting_note` DISABLE KEYS */;
/*!40000 ALTER TABLE `esdc_reporting_note` ENABLE KEYS */;
UNLOCK TABLES;
