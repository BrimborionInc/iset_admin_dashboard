...
--
-- Dumping data for table `iset_application_draft_dynamic`
--

LOCK TABLES `iset_application_draft_dynamic` WRITE;
/*!40000 ALTER TABLE `iset_application_draft_dynamic` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_application_draft_dynamic` ENABLE KEYS */;
UNLOCK TABLES;
