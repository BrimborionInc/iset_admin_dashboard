...
--
-- Dumping data for table `iset_case_note`
--

LOCK TABLES `iset_case_note` WRITE;
/*!40000 ALTER TABLE `iset_case_note` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_case_note` ENABLE KEYS */;
UNLOCK TABLES;
