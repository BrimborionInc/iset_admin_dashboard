...
--
-- Dumping data for table `iset_event_receipt`
--

LOCK TABLES `iset_event_receipt` WRITE;
/*!40000 ALTER TABLE `iset_event_receipt` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_event_receipt` ENABLE KEYS */;
UNLOCK TABLES;
