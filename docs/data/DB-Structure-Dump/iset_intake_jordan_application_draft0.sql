...
--
-- Dumping data for table `jordan_application_draft`
--

LOCK TABLES `jordan_application_draft` WRITE;
/*!40000 ALTER TABLE `jordan_application_draft` DISABLE KEYS */;
/*!40000 ALTER TABLE `jordan_application_draft` ENABLE KEYS */;
UNLOCK TABLES;
