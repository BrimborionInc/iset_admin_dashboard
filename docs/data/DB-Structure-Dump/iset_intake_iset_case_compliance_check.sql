...
--
-- Table structure for table `iset_case_compliance_check`
--

DROP TABLE IF EXISTS `iset_case_compliance_check`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `iset_case_compliance_check` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `case_id` bigint unsigned NOT NULL,
  `requirement_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `fk_case_compliance_document` (`evidence_document_id`),
  KEY `fk_case_compliance_created_by` (`created_by_staff_profile_id`),
...
--
-- Dumping data for table `iset_case_compliance_check`
--

LOCK TABLES `iset_case_compliance_check` WRITE;
/*!40000 ALTER TABLE `iset_case_compliance_check` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_case_compliance_check` ENABLE KEYS */;
UNLOCK TABLES;
