...
--
-- Dumping data for table `contact_message_note`
--

LOCK TABLES `contact_message_note` WRITE;
/*!40000 ALTER TABLE `contact_message_note` DISABLE KEYS */;
INSERT INTO `contact_message_note` VALUES (3,3,48,'Internal Note','2025-10-22 17:00:25');
/*!40000 ALTER TABLE `contact_message_note` ENABLE KEYS */;
UNLOCK TABLES;
