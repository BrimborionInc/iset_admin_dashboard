...
--
-- Table structure for table `contact_message_status_history`
--

DROP TABLE IF EXISTS `contact_message_status_history`;
...
--
-- Dumping data for table `contact_message_status_history`
--

LOCK TABLES `contact_message_status_history` WRITE;
/*!40000 ALTER TABLE `contact_message_status_history` DISABLE KEYS */;
INSERT INTO `contact_message_status_history` VALUES (3,3,'new','new',48,'2025-10-22 16:39:17');
/*!40000 ALTER TABLE `contact_message_status_history` ENABLE KEYS */;
UNLOCK TABLES;
