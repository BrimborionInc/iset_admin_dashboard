...
--
-- Dumping data for table `queue_event_log`
--

LOCK TABLES `queue_event_log` WRITE;
/*!40000 ALTER TABLE `queue_event_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `queue_event_log` ENABLE KEYS */;
UNLOCK TABLES;
