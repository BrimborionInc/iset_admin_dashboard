...
--
-- Table structure for table `iset_case_event`
--
...
CREATE TABLE `iset_case_event` (
  ...
  `source_system` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `fk_case_event_actor_user` (`actor_user_id`),
...
--
-- Dumping data for table `iset_case_event`
--

LOCK TABLES `iset_case_event` WRITE;
/*!40000 ALTER TABLE `iset_case_event` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_case_event` ENABLE KEYS */;
UNLOCK TABLES;
