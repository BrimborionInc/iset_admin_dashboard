...
--
-- Dumping data for table `iset_application_draft`
--

LOCK TABLES `iset_application_draft` WRITE;
/*!40000 ALTER TABLE `iset_application_draft` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_application_draft` ENABLE KEYS */;
UNLOCK TABLES;
