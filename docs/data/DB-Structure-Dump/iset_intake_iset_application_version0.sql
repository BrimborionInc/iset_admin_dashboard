...
--
-- Dumping data for table `iset_application_version`
--

LOCK TABLES `iset_application_version` WRITE;
/*!40000 ALTER TABLE `iset_application_version` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_application_version` ENABLE KEYS */;
UNLOCK TABLES;
