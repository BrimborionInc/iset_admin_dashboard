...
--
-- Dumping data for table `iset_application_file`
--

LOCK TABLES `iset_application_file` WRITE;
/*!40000 ALTER TABLE `iset_application_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `iset_application_file` ENABLE KEYS */;
UNLOCK TABLES;
